...
filename='mutant_168_right';

contra='241018Mice_mutant__E12B0.BLK.mat'
ipsi='241018Mice_mutant__E11B0.BLK.mat'
...
figure, subplot(1,2,1),imagesc(LC1eq), axis image, colormap  gray
 subplot(1,2,2),imagesc(RC1eq), axis image, colormap gray
 
[im1,im2,ROI]=selec_roi(LC1eq,RC1eq);
% ROI=ones(size(RC1eq))
...
[contra_eq,SNR_contra]=estimate_back_noise(contra_eq,ROI) 
fprintf('snr for contra stim is: %2f\n', SNR_contra);
[ipsi_eq,SNR_ipsi]=estimate_back_noise(ipsi_eq,ROI) 
