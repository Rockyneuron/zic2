function[SNR]=sig2noise_3(It,im,roiS,roiB)
%--------------------------------------------------------------------------
...
[SNR.global,SNR.bl]=sig_timecourse(totr,totr,roiS,roiB);
...
[SNR.c1resp,SNR.c1bl]=sig_timecourse(It.Gp1,It.Gp1,SNR.c1_roi,roiB);
[SNR.c2resp,SNR.c2bl]=sig_timecourse(It.Gp2,It.Gp2,SNR.c2_roi,roiB);
[SNR.c3resp,SNR.c3bl]=sig_timecourse(It.Gp3,It.Gp3,SNR.c3_roi,roiB);
[SNR.c4resp,SNR.c4bl]=sig_timecourse(It.Gp4,It.Gp4,SNR.c4_roi,roiB);
...
f4=figure, 
errorbar(1:20,SNR.c1_rat(1,:),SNR.c1resp(2,:),'-o','LineWidth',wd ), hold on,
errorbar(1:20,SNR.c2_rat(1,:),SNR.c2resp(2,:),'-o','LineWidth',wd ), hold on,
errorbar(1:20,SNR.c3_rat(1,:),SNR.c3resp(2,:),'-o','LineWidth',wd ), hold on,
errorbar(1:20,SNR.c4_rat(1,:),SNR.c4resp(2,:),'-o','LineWidth',wd ),hold on,
line(1:length(SNR.bl),repmat(0,1,length(SNR.bl)),'Color','Black','LineWidth',wd )
 legend('c1','c2','c3','c4'),set(gca,'Xlim',[1,20])
 xlabel('frames'), ylabel('sig-blank/std(blank)')
 f4.Name='SNR std ratio';


f4=figure, 
errorbar(1:20,SNR.c1_c(1,:),SNR.c1resp(2,:),'-o','LineWidth',wd ), hold on,
errorbar(1:20,SNR.c2_c(1,:),SNR.c2resp(2,:),'-o','LineWidth',wd ), hold on,
errorbar(1:20,SNR.c3_c(1,:),SNR.c3resp(2,:),'-o','LineWidth',wd), hold on,
errorbar(1:20,SNR.c4_c(1,:),SNR.c4resp(2,:),'-o','LineWidth',wd ),hold on,
line(1:length(SNR.bl),repmat(0,1,length(SNR.bl)),'Color','Black','LineWidth',wd )
 legend('c1','c2','c3','c4'),
