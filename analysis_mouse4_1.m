...
filename='cont_359_left';

contra='131217_mice359cont__E13B0.BLK.mat'
ipsi='131217_mice359cont__E9B0.BLK.mat'
...
figure, histogram(data.seg.contra_raw), title('segmented contra ipsi signal comparison'),hold on,
